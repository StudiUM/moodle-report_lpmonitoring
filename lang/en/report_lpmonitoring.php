...
$string['finalratingplan'] = 'Final rating';
$string['grade'] = 'Grade';
...
$string['proficientscalevalue'] = 'Proficient';
$string['rated'] = 'Rated';
$string['ratingnumber'] = '<strong>({$a})</strong> rating';
$string['saved'] = 'Information has been saved';
...
$string['studentusingtemplate'] = 'Student using this template';
