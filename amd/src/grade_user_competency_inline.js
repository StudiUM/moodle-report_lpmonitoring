...
/**
 * Module to enable inline editing of a competency grade.
 *
 * This is a thin wrapper around tool_lp/grade_user_competency_inline that
 * uses report_lpmonitoring/grade_dialogue (which defers template JS execution
 * until the dialogue is in the DOM) instead of tool_lp/grade_dialogue.
 *
 * @module     report_lpmonitoring/grade_user_competency_inline
...
define(['jquery',
     ...
     * InlineEditor
     *
     * @class report_lpmonitoring/grade_user_competency_inline
